...
For a boolean data type, it should also include the rows that contain the category values. The `partID` and `set` from each row should be included in the category value rows.
