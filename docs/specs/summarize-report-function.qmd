...
errors: ErrorSummary = {
    'addresses': [
        ...
        E(ruleId='_total', count=6, key='table',  value='addresses'),
        E(ruleId='_total', count=3, key='column', value='addId'),
        E(ruleId='_total', count=3, key='column', value='addL1'),
        E(ruleId='_total', count=3, key='row',    value='1'),
        E(ruleId='_total', count=3, key='row',    value='2'),
    ]
}
```
...
errors: ErrorSummary = {
    'addresses': {
        table: {'x': 4, 'y': 2, '_total': 6},
        column: {
            'addId': {'x': 1, 'y': 2, '_total': 3},
            'addL1': {'x': 3, '_total': 3},
        },
        row: {
            '1': {'x': 2, 'y': 1, '_total': 3},
