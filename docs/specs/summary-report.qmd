...
The summary should include the count of each error and warning type encountered. 
For example, for the dataset above, the summary report should inform the user that 
there are:
