...
- `data-file`
  ...
  The path of the Excel/CSV file to be validated.
...
- Validate a CSV file with the latest ODM version, and print human readable
  errors to the console:

    `python tools/validate.py measures.csv`
